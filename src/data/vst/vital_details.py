...
BASE_DETAILS: Dict[str, Tuple[float, float]] = {
    "bypass": (0.0, 1.0),
    "beats_per_minute": (0.333333333, 6.016666889),
    ...
    "compressor_enabled_bands": (0.0, 3.0),
...
OSC_DETAILS = {
    ...
    "distortion_type": (0.0, 13.0),
    "distortion_amount": (0.0, 1.0),
    "distortion_spread": (-0.5, 0.5),
    "spectral_morph_type": (0.0, 15.0),
