...
SURGE_XT_PARAM_SPEC = ParamSpec(
    [
        ...
        # Filters
        ContinuousParameter(name="a_feedback", min=0.0, max=1.0, constant_val_p=0.5, constant_val=0.5),
        ContinuousParameter(
        ...
        ContinuousParameter(name="a_osc_1_pitch", min=0.0, max=1.0, constant_val_p=0.5, constant_val=0.5),
        CategoricalParameter(
            name="a_osc_1_route",
        ...
        ContinuousParameter(name="a_osc_2_pitch", min=0.0, max=1.0, constant_val_p=0.5, constant_val=0.5),
        CategoricalParameter(
            name="a_osc_2_route",
            values=["Filter 1", "Both", "Filter 2"],
            raw_values=[0.1265, 0.5005, 0.874],
        ...
        ContinuousParameter(name="a_osc_3_pitch", min=0.0, max=1.0, constant_val_p=0.5, constant_val=0.5),
        CategoricalParameter(
            name="a_osc_3_route",
            values=["Filter 1", "Both", "Filter 2"],
            raw_values=[0.1265, 0.5005, 0.874],
