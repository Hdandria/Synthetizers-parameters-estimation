...
VITAL_PARAM_SPEC = ParamSpec(
    [
        ...
        CategoricalParameter(
            name="filter_1_model",
            values=list(range(8)),
            raw_values=_evenly_spaced(8),
            encoding="onehot",
        ),
        CategoricalParameter(
            name="filter_1_filter_input",
            values=[False, True],
            raw_values=[0.0, 1.0],
            encoding="onehot",
        ),
        ...
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_phase_randomization", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
        ...
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_unison_frame_spread", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
        ...
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_frequency_morph_spread", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_frequency_morph_phase", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        # Sample section
        ...
        CategoricalParameter(
            name="portamento_force",
            values=[False, True],
            raw_values=[0.0, 1.0],
            encoding="onehot",
        ),
        CategoricalParameter(
            name="portamento_scale",
            values=[False, True],
            raw_values=[0.0, 1.0],
            encoding="onehot",
        ),
        ...
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_distortion_amount", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_distortion_phase", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_distortion_spread", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
            CategoricalParameter(
                ...
                values=list(range(14)),  # matches SynthOscillator::kNumDistortionTypes
                raw_values=_evenly_spaced(14),
                encoding="onehot",
            )
            for i in range(1, 4)
        ],
        *[
            ContinuousParameter(
                name=f"oscillator_{i}_transpose_quantize", min=0.0, max=1.0
            )
            for i in range(1, 4)
        ],
        *[
    ...
    [
        ...
        *[
            ...
            for param in [
                ...
                ContinuousParameter(name=f"oscillator_{i}_tune", min=0.0, max=1.0),
                ContinuousParameter(
                    name=f"oscillator_{i}_unison_detune", min=0.0, max=1.0
                ),
                CategoricalParameter(
                    name=f"oscillator_{i}_unison_voices",
                    values=list(range(1, 17)),
                ...
                ContinuousParameter(name=f"oscillator_{i}_blend", min=0.0, max=1.0),
                ContinuousParameter(
                    name=f"oscillator_{i}_wave_frame", min=0.0, max=1.0
                ),
                ContinuousParameter(
                    name=f"oscillator_{i}_frequency_morph_amount", min=0.0, max=1.0
                ),
...
VITAL_SIMPLE_LEGACY_PARAM_SPEC = ParamSpec(
    [
        # Global / transport
        ContinuousParameter(name="beats_per_minute", min=0.0, max=1.0),
        ContinuousParameter(name="volume", min=0.0, max=1.0),
