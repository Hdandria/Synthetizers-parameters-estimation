...
downloaded_archives.extend(
    kvraudio.download(save_path, os.path.join(script_dir, "kvr_cookies.txt"))
)
...
total_fxp += presetshare.download(
    presetshare_path, os.path.join(script_dir, "presetshare_cookies.txt")
)
